...
def json_to_markdown(resume_data: dict) -> str:
    ...
    if resume_data.get('skills'):
        ...
        if isinstance(skills, list):
            categories = {
                'Languages': ['python', 'java', 'javascript', 'c++', 'c#', 'go', 'rust', 'typescript', 'swift',
                              'kotlin', 'sql', 'html', 'css'],
                'Frameworks/Libraries': ['react', 'angular', 'vue', 'django', 'flask', 'spring', 'express', 'next',
                                         'node'],
                'Tools/Technologies': ['git', 'docker', 'kubernetes', 'aws', 'azure', 'jenkins', 'linux', 'mongodb',
                                       'postgresql', 'mysql']
            }
